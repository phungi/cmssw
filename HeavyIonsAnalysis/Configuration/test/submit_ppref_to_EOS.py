...
config.General.requestName = 'Run2_ppref_EOS_batch2_again'
...
config.JobType.outputFiles = ['Run2_ppref_EOS_batch2.root']
...
config.Data.outLFNDirBase = '/store/group/phys_heavyions/vavladim/Run2_ppref_EOS'
# config.Data.outLFNDirBase = '/store/user/vavladim/Run2_ppref_charged_change'
