...
process.forest = cms.Path(process.HiForestInfo+process.hiEvtAnalyzer+process.hltanalysis+process.extraJetsData+process.jetsR4+process.akCs4PFJetAnalyzer+process.extraJetsData+process.unsubtractedJetR4+process.ak4PFJetAnalyzer+process.hiFJRhoFlowModulationProducer+process.rhoAnalysis+process.randomConeAnalysisR4+process.randomConeAnalysisR2)
