...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        ...
        '/store/data/Run2017G/HighEGJet/MINIAOD/UL2017_MiniAODv2-v1/00000/0C8916F9-C6F1-1C4B-9BAD-BF293FDBF178.root'
    )
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string("ppref_data.root"))
...
from HeavyIonsAnalysis.EventAnalysis.hltobject_cfi import trigger_list_custom
process.hltobject.triggerNames = trigger_list_custom
# process.hltobject.triggerNames = cms.vstring('HLT_HIAK4CaloJet100_v1','HLT_HIAK4CaloJet80_v1')
...
if addR2Jets or addR4Jets or addR3Jets:
    ...
    if addR2Jets :
        ...
        process.ak2PFpatJetCorrFactors.levels = ['L2Relative', 'L3Absolute', 'L2L3Residual']
        process.ak2PFpatJetCorrFactors.primaryVertices = "offlineSlimmedPrimaryVertices"
        process.load("HeavyIonsAnalysis.JetAnalysis.candidateBtaggingMiniAOD_cff")
        process.ak2PFJetAnalyzer = process.ak4PFJetAnalyzer.clone(rParam = 0.2, jetTag = "ak2PFpatJets", jetName = 'ak2PF')
    ...
    if addR3Jets :
        ...
        process.ak3PFpatJetCorrFactors.levels = ['L2Relative', 'L3Absolute', 'L2L3Residual']
        process.ak3PFpatJetCorrFactors.primaryVertices = "offlineSlimmedPrimaryVertices"
        process.load("HeavyIonsAnalysis.JetAnalysis.candidateBtaggingMiniAOD_cff")
        process.ak3PFJetAnalyzer = process.ak4PFJetAnalyzer.clone(rParam = 0.3, jetTag = "ak3PFpatJets", jetName = 'ak3PF')
    ...
    if addR4Jets :
        ...
        process.ak04PFpatJetCorrFactors.levels = ['L2Relative', 'L3Absolute', 'L2L3Residual']
...
#     src = cms.untracked.InputTag("unpackTV"),
#     # tracks_ = cms.InputTag("hiTracks"),
# )
# process.pBeamScrapingFilter=cms.Path(process.unpackTV*process.NoScraping)
