...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        # '/MinBias_Hydjet_Drum5F_2018_5p02TeV/HINPbPbSpring21MiniAOD-NoPUmva98_112X_upgrade2018_realistic_HI_v9-v1/MINIAODSIM'
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string("Run2_embedded_charged_constituent.root"))
...
process.forest += process.hiFJRhoFlowModulationProducer * process.rhoAnalysis * process.randomConeAnalysisR4 * process.randomConeAnalysisR2 * process.randomConeAnalysisR3
