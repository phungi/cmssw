...
jobTag = "Embedded_jetID_energyFraction_CompensatoryNeutralScalingMaps_ptMap"
config = config()
...
config.JobType.psetName = '/afs/cern.ch/user/v/vavladim/private/CMSSW_12_5_0/src/HeavyIonsAnalysis/Configuration/test/embedded_run2_forest.py'
...
# config.Data.outLFNDirBase = '/store/user/vavladim/Run2_embedded_charged_qg'
