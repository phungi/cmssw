...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        # '/DiJet_pThat-15_TuneCP5_HydjetDrumMB_5p02TeV_Pythia8/HINPbPbSpring21MiniAOD-FixL1CaloGT_New_Release_112X_upgrade2018_realistic_HI_v9-v1/MINIAODSIM'
        '/store/himc/HINPbPbSpring21MiniAOD/DiJet_pThat-15_TuneCP5_HydjetDrumMB_5p02TeV_Pythia8/MINIAODSIM/FixL1CaloGT_New_Release_112X_upgrade2018_realistic_HI_v9-v1/2520000/02b72feb-24f3-48ad-a791-09a777b64745.root'
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string("Run2_embedded_fn_noResetting.root"))
...
matchJets = True # Enables q/g and heavy flavour jet identification
...
if addR2Jets or addR3Jets or addR3FlowJets or addR4Jets or addR4FlowJets :
    ...
    if addR2Jets :
        ...
        process.akCs2PFJetAnalyzer = process.akCs4PFJetAnalyzer.clone(rParam = 0.2, jetTag = jetName + "patJets", jetName = jetName, genjetTag = "ak2GenJetsNoNu", matchJets = matchJets, matchTag = "ak2PFMatchingFor" + jetName + "patJets")      
    ...
    if addR3Jets :
        ...
        process.akCs3PFJetAnalyzer = process.akCs4PFJetAnalyzer.clone(rParam = 0.3, jetTag = jetName + "patJets", jetName = jetName, genjetTag = "ak3GenJetsNoNu", matchJets = matchJets, matchTag = "ak3PFMatchingFor" + jetName + "patJets")      
