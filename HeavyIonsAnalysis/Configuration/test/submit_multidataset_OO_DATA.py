...
config.Data.lumiMask = '/afs/cern.ch/user/v/vavladim/public/OO_setup/CMSSW_15_0_11/src/HeavyIonsAnalysis/Configuration/test/Cert_Collisions2025OO_394153_394217_golden.json'
...
if __name__ == '__main__':
    ...
    for dataset in dataset_list_2024PbPb:
        ...
        config.General.requestName = 'OO_filtered_' + dataset.split('/')[1]
