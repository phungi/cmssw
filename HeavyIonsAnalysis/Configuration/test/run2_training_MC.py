...
# these need to be on for saving the track/svtx info
doTracks = True
doSvtx = True
...
getattr(process,"akCs"+jetLabel+"PFJetAnalyzer").genjetTag = "ak"+jetLabel+"GenJetsRecluster" 
...
getattr(process,"akCs"+jetLabel+"PFJetAnalyzer").matchOriginal = cms.untracked.bool(False)
#getattr(process,"akCs"+jetLabel+"PFJetAnalyzer").originalCSTag = 'patJetsAKCs'+jetLabel+'PFUnsubJets'
...
getattr(process,"akCs"+jetLabel+"PFJetAnalyzer").jetPtMin = 20
