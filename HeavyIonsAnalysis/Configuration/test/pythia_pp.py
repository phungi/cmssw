...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        '/store/himc/RunIIpp5Spring18DR/QCD_pThat-15_Dijet_TuneCP5_5p02TeV_pythia8/AODSIM/94X_mc2017_realistic_forppRef5TeV_v1-v1/230000/06182015-3497-E911-B8D3-008CFA197D8C.root'
    ),
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string("Crab_embedded.root"))
