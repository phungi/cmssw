...
config.General.requestName = 'Run2_embedded_match_correction'

config.section_('JobType')
config.JobType.psetName = '/afs/cern.ch/user/v/vavladim/private/CMSSW_12_5_0/src/HeavyIonsAnalysis/Configuration/test/RCRhoZ_run2_embedded.py'
config.JobType.pluginName = 'Analysis'
config.JobType.outputFiles = ['Run2_embedded_match_correction.root']
...
config.Data.outLFNDirBase = '/store/user/vavladim/Run2_embedded_match_correction'
