...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        # 'file:/afs/cern.ch/user/v/vavladim/private/CMSSW_10_6_30_patch1/src/HeavyIonsAnalysis/Configuration/test/A8E45EA6-4F97-E911-8BCE-B496910A9A7C.root'
        '/store/himc/RunIIpp5Spring18MiniAOD/QCD_pThat-15_Dijet_TuneCP5_5p02TeV_pythia8/MINIAODSIM/94X_mc2017_realistic_forppRef5TeV-v1/230000/02EE69BF-708F-E911-9CC0-141877411970.root'
    )
)
...
process.GlobalTag = GlobalTag(process.GlobalTag, '123X_mc2017_realistic_v2', '')
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string("ppref_MC_pythia.root"))
...
if addR3Jets or addR4Jets :
    ...
    if addR2Jets :
        ...
        setupPprefJets('ak2PF', process.jetsR2, process, isMC = 1, radius = 0.20, JECTag = 'AK2PF')
        ...
        process.forest += process.extraJetsMC * process.jetsR2 * process.ak2PFJetAnalyzer
    ...
    if addR3Jets :
        ...
        process.load("HeavyIonsAnalysis.JetAnalysis.candidateBtaggingMiniAOD_cff")
        process.ak3PFJetAnalyzer = process.ak4PFJetAnalyzer.clone(rParam = 0.3, jetTag = "ak3PFpatJets", jetName = 'ak3PF', genjetTag = "ak3GenJetsNoNu")
