...
config.General.requestName = 'Run2_data_MinBias_EOS'

config.section_('JobType')
config.JobType.psetName = '/afs/cern.ch/user/v/vavladim/private/CMSSW_12_5_0/src/HeavyIonsAnalysis/Configuration/test/EOS_minbias.py'
config.JobType.pluginName = 'Analysis'
config.JobType.outputFiles = ['Run2_data_MinBias_EOS.root']
...
config.Data.outLFNDirBase = '/store/group/phys_heavyions/vavladim/Run2_data_MinBias'
